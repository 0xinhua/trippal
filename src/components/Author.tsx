...
import authorImage from '@/images/avatars/avatar.png'
        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">{t("author name")} &ndash;</span> {t("author title")}
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              {t("author description one")}
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              {t("author description two")}
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              {t("author description three")}
            </p>
            <p className="mt-8">
              <Link
                href="https://x.com/0xinhua"
              ...
              >
                ...
                <span className="ml-4">{t("Follow me on X")}</span> <span className="sr-only">Follow me on X</span>
              </Link>
            </p>
          </div>
        </div>
