        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 text-lg tracking-tight text-blue-200">
              {t("Enter your email address and I’ll send you a sample from the book containing two of my favorite chapters.")}
            </p>
          </div>
          <form className="lg:pl-16" onSubmit={(e) => {
            ...
            <h3 className="text-base font-medium tracking-tight text-white">
              {t("Get two free chapters straight to your inbox")}{' '}
